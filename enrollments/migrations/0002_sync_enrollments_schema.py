# Generated to ensure all enrollments models and columns exist in production PostgreSQL and fresh databases

from django.conf import settings
from django.db import migrations


def sync_enrollments_schema(apps, schema_editor):
    from django.apps import apps as global_apps
    app_config = global_apps.get_app_config('enrollments')
