...
COURSE_DATA = [
    {
        ...
        'short_code': 'UI/UX',
        'thumbnail_url': 'https://placehold.co/800x450/png?text=UI%2FUX+Design',
    ...
    },
    {
        ...
        'short_code': 'DR',
        'thumbnail_url': 'https://placehold.co/800x450/png?text=Draft+Course',
        'category_slug': None,
        'is_published': False,
    },
    {
        ...
        'short_code': 'PY-101',
        'thumbnail_url': 'https://placehold.co/800x450/png?text=Python+Bootcamp',
    ...
    },
    {
        ...
        'short_code': 'BA-PY',
        'thumbnail_url': 'https://placehold.co/800x450/png?text=Business+Analytics',
